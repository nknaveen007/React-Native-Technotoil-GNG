...
{select?
  <Card  style={{width:'90%',alignSelf:'center',marginTop:"4%"}}>
    <Text style={{fontFamily:'Gotham',marginLeft:'3%',marginTop:'3%',fontSize:16}}>Availibility</Text>
...
renderItem={({item,index})=>{
    ...
    return(
     <View style={{flexDirection:'row'}}>
      ...
      <Text style={{alignSelf:'center',fontFamily:'Gotham',color:'gray',marginLeft:'5%',width:'50%'}}>{dayTimeslot[item]}</Text>
