      ...
      <View style={styles.headerContainer}>
          ...
          <AntDesign name="arrowleft" size={26} color="#A8062A" style={{alignSelf:'center'}} onPress={()=>navigation.goBack()}/>
              ...
              <View style={styles.bodyContainer}>
                       ...
                       <Text style={styles.sideHeading}>We have sent a verification code on your number  <Text style={{color:'silver',fontFamily:'GothamBold'}}>+{route.params.code } {number}</Text> .Please enter the verification code below.</Text>
